		<div class="navbar" role="navigation">
	        ...
	        <ul class="nav navbar-nav navbar-right visible-md visible-lg">
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo $assets?>/real/ico/flags/USA.png" style="height:18px; margin-top:-4px;"></a>
	        		<ul class="dropdown-menu">
						<li><a href="#"><img src="<?php echo $assets?>/real/ico/flags/USA.png" style="height:18px; margin-top:-2px;"> US</a></li>
						<li><a href="#"><img src="<?php echo $assets?>/real/ico/flags/Spain.png" style="height:18px; margin-top:-2px;"> Spanish</a></li>
						<li><a href="#"><img src="<?php echo $assets?>/real/ico/flags/Germany.png" style="height:18px; margin-top:-2px;"> German</a></li>
						<li><a href="#"><img src="<?php echo $assets?>/real/ico/flags/Poland.png" style="height:18px; margin-top:-2px;"> Polish</a></li>	
	        		</ul>
	      		</li>
				<li class="dropdown visible-md visible-lg">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img class="avatar" src="<?php echo $assets?>/real/img/avatar.jpg">
								<div>New message</div>
