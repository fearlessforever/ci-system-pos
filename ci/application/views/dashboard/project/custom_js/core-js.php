...
$(document).ready(function(){
	loadCSS("<?php echo $assets ?>/sentor/plugins/gritter/css/jquery.gritter.css");
	loadCSS("<?php echo $assets ?>/sentor/plugins/gritter/css/aku-gritter.css");
	function pemberitahuan() { 		
		$.ajax({
			url: "<?php echo $home ?>/user/autojs/bz",
			type:'GET', 
			success: function(data){
