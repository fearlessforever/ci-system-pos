...
<div class="row" style="min-height:750px;">
	<div class="col-lg-12">
		<div class="row">
			...
			<h1>Supplier dari Barang / Jasa</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12 main-box"> 
				<header class="main-box-header clearfix">
					<h2 class="pull-left">Supplier</h2>
					<div class="filter-block pull-right">
					<a href="#" class="btn btn-primary pull-right" data-tombol="tambah">
						<i class="fa fa-plus-circle fa-lg"></i> Tambah Supplier
					</a>
					</div>
				</header>
...
],'<?php echo $asset ?>js/supplier.js','content-wrapper');
