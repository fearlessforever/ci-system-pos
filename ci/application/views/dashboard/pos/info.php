<div class="row">
	...
	<div class="main-box clearfix" style="min-height: 1100px;">
		<div class="tabs-wrapper tabs-no-header">
			...
			<li><a href="#tab-accounts" data-toggle="tab">Log System POS </a></li>
			</ul>
...
<?php
	$core =$this->db->query(
		"SELECT tipe,id,judul,keterangan FROM z_info WHERE tipe=? "
	,array('author') )->result_array();
	if(isset($core[0]) && is_array($core) ){
...
<div class="tab-pane fade" id="tab-accounts">
		<h3><span>Log System POS By Helmi</span></h3>
		<div class="panel-group accordion" id="accordion2">
<?php
	$core =$this->db->query(
		"SELECT tipe,id,judul,keterangan FROM z_info WHERE tipe=? ORDER BY tanggal ASC"
	,array('log') )->result_array();
	if(isset($core[0]) && is_array($core) ){ 
		$str =' '; 
		foreach($core as $val){
			$str .= '
