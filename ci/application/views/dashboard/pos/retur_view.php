	...
	<div class="col-lg-12">
		<div class="row">
			<div class="col-lg-12">
				<ol class="breadcrumb">
					<li><a href="#">Home</a></li>
					<li class="active"><span>Retur </span></li>
				</ol>
			<h1>Retur untuk Transaksi Pendapatan & Pengeluaran</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12 main-box"> 
				<header class="main-box-header clearfix">
					<h2 class="pull-left">List Retur Yang Ada </h2>
...
],'<?php echo $asset ?>js/retur.js','content-wrapper');
