...
<style>
<!--
.total_jml { width:100%; margin-top:5px; float:left; font-size:50px; font-weight:bold; text-align:right; background-color:#000; color:#fff; padding:10px ; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; -moz-box-shadow:0px 0px 3px #aaa; -webkit-box-shadow:0px 0px 3px #aaa; box-shadow:0px 0px 3px #aaa; font-family:"Courier New", Courier, monospace; }
-->
</style>
<script>
helmi.controller ='<?php echo isset($__controller)?$__controller:''; ?>';
	...
	loadJS(requireJS,"<?php echo $asset ?>js/transaksi-pengeluaran.js",'content-wrapper');
	...
	<div class="col-lg-12">
		<div class="row">
			<div class="col-lg-12">
				<ol class="breadcrumb">
					...
					<li class="active"><span>Pembelian / Pengeluaran </span></li>
				</ol> 
			</div>
		</div> 
		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-12">
				<div class="main-box ">
					<header class="main-box-header clearfix"> <h2>Pengeluaran / Pembelian</h2> </header>
			<div class="main-box-body clearfix">
				<form role="form">
