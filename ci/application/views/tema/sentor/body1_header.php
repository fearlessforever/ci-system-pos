...
<?php /* <li class="dropdown hidden-xs">
				...
				<li class="dropdown hidden-xs">
					...
					<ul class="dropdown-menu notifications-list messages-list">
						...
						<li class="item"> <a href="#"> Tidak Ada Transaksi Baru </a> </li>
					</ul>
				</li>
				...
				<li class="dropdown profile-dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img src="<?php echo (isset($userdata['folder']) && isset($userdata['profile_pic']) )? $asset . $userdata['folder'] . $userdata['profile_pic'] : $asset .'noimage.jpg' ; ?>" alt=""/>
						<span class="hidden-xs"><?php echo $this->session->_user['nama']; ?></span> <b class="caret"></b>
					</a>
